...
const char dg_getslstringatdepthname[] = "dg_getslstringatdepth";

unsigned char* dg_getslstringatdepth(
    Bufferhandle* pBHarrayhead,
    UINT64  offsetbufferid,
    UINT64  stringbufferid,
    ...
    UINT64* pstringlength)
{
    ...
    if (dg_geterrorcount(pBHarrayhead) != olderrorcount)
    {
        dg_pusherror(pBHarrayhead, dg_getslstringatdepthname);
        return((unsigned char*)badbufferhandle);
    }
